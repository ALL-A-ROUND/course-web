                                    ...
                                    <div className="mt-1 grid grid-cols-3 gap-3">
                                        ...
                                        <div>
                                            <button
                                                className=" inline-flex w-full justify-center rounded-md border border-gray-300 bg-white py-2 px-4 text-sm font-medium text-gray-500 shadow-sm hover:bg-gray-50"
                                            >
                                                <span className="sr-only">Sign in with QR Code</span>
                                                {/*<svg className="h-5 w-5" aria-hidden="true" fill="currentColor"*/}
                                                {/*     viewBox="0 0 20 20">*/}
                                                {/*    <path*/}
                                                {/*        fillRule="evenodd"*/}
                                                ...
                                                {/*    />*/}
                                                {/*</svg>*/}
                                                <QrCodeIcon className="text-gray-500 h-5 w-5"/>
                                            </button>
                                        </div>
                                    </div>
                                    <div className={"mt-2"}>
...
function QRCodeSection() {
    return (<>
        <img src={process.env.NEXT_PUBLIC_API_ENDPOINT + "/auth/qrcode"} alt=""/>
    </>)
}