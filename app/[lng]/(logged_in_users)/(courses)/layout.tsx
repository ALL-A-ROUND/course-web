...
export default async function HomeLayout({
    ...
    return (
        <div className=" w-full min-h-screen">
            ...
            <nav className="fixed bottom-0 w-full h-16 flex flex-row items-center justify-between bg-[#9F9C79] px-4">
                ...
                <Link href="/search" passHref>
                    <div className={cn("rounded-full items-center flex flex-col relative h-full w-32",
